...
static ALL_LOCALES: &'static [&'static str] = &[
...
static NOT_WANTED_LOCALES: &'static [&'static str] = &[
    "/Cy-az-AZ",
    "/Cy-sr-SP",
    "/Cy-uz-UZ",
    "/Lt-az-AZ",
...
pub fn is_same_domain(link: &String, domain: &String) -> bool {
    let url = Url::parse(link).unwrap();
    let link_domain = url.domain();
    if link_domain.is_none() {
        return false;
    }
    let link_domain = link_domain.unwrap();
